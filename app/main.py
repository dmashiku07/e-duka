...
#Home page endpoint. User Sign in and Administration Sign in.
@app.route("/")
def root():
...
#Endpoint to add items into the shopping cart database
...
def account_orders():
    ...
    for row in products:
        totalPrice += row[2]
    return render_template("orders.html", products=products, totalPrice=totalPrice, loggedIn=loggedIn,
...
def cartout():
    ...
    for row in products:
        totalPrice += row[2]
    return render_template("cartout.html", products=products, totalPrice=totalPrice, loggedIn=loggedIn,
                           firstName=firstName, noOfItems=noOfItems)
...
def checkout():
    ...
    for row in products:
        totalPrice += row[2]
    return render_template("cart1.html", products=products, totalPrice=totalPrice, loggedIn=loggedIn,
                           firstName=firstName, noOfItems=noOfItems)
